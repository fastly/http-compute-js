...
// This file modeled after Node.js - /lib/_http_incoming.js
...
// the headers and the body. So we'll be building this object by using various parts of
// the Compute@Edge Request object, such as the 'headers' dict to parse out headers,
// and the underlying ReadableStream object for the body.
